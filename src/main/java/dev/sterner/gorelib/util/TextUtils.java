...
public class TextUtils {
    ...
    private static void renderRawText(MatrixStack stack, String text, int x, int y) {
        ...
        font.draw(stack, text, x - 1, y, new Color(96, 236, 227, 214).getRGB());
        font.draw(stack, text, x + 1, y, new Color(128, 165, 149, 142).getRGB());
        font.draw(stack, text, x, y - 1, new Color(128, 208, 197, 183).getRGB());
        font.draw(stack, text, x, y + 1, new Color(96, 105, 109, 102).getRGB());

        font.draw(stack, text, x, y, new Color(255, 50, 50, 50).getRGB());
    }
}
